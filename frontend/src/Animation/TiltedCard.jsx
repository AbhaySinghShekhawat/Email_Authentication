...
export default function TiltedCard({
  ...
  return (
    <figure
      ref={ref}
      className="relative flex flex-col items-center justify-center w-full [perspective:800px]"
    ...
    >
      ...
      <motion.div
        className="
          relative 
          w-full 
          max-w-[320px]        /* default mobile size */
          sm:max-w-[400px]     /* small screens */
          md:max-w-[450px]     /* medium screens */
